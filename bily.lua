...
keyboard.inline_keyboard = {{{text = '⌯ 𝑠𝑜𝑢𝑟𝑐𝑒 𝑏𝑖𝑙𝑦 .',url="t.me/BILY_DEV"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IITlTI/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source bily     --
if Admin(msg) then
...
⌯︙البوت الخدمي • التواصل
※┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉※
⌯︙[𝚂𝙾𝚄𝚁??𝙴𝚂 𝙱𝙸𝙻𝚈](https://t.me/BILY_DEV)
]]
Dev_Abs(msg.chat_id_, msg.id_, 1, (Help or Text), 1, 'md')
end end
...
os.execute('rm -rf bily.lua') 
os.execute('wget https://raw.githubusercontent.com/bilyTeam5/bily/bily/bily.lua') 
dofile('bily.lua') 
