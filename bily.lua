...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/Song:"..data.sender_user_id_}},{{text=". WaTaN TeaM ◉",url="t.me/IQTHON"}}} 
...
local Text ='*◉︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/mp3:"..data.sender_user_id_}},{{text=". WaTaN TeaM ◉",url="t.me/IQTHON"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/memz:"..data.sender_user_id_}},{{text=". WaTaN TeaM ◉",url="t.me/IQTHON"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/gif:"..data.sender_user_id_}},{{text=". WaTaN TeaM ◉",url="t.me/IQTHON"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/photo:"..data.sender_user_id_}},{{text=". WaTaN TeaM ◉",url="t.me/IQTHON"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/anime:"..data.sender_user_id_}},{{text=". WaTaN TeaM ◉",url="t.me/IQTHON"}}} 
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ bily TeAM.',url="t.me/IQTHON"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
◉︙[Source Channel](https://t.me/IQTHON)
]] 
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/IQTHON"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/IQTHON"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = "◉︙تم ترتيب الاوامر بالشكل التالي ~\n◉︙ايدي - ا .\n◉︙رفع مميز - م .\n◉︙رفع ادمن - اد .\n◉︙رفع مدير - مد . \n◉︙رفع منشى - من . \n◉︙رفع منشئ الاساسي - اس  .\n◉︙رفع مطور - مط .\n◉︙رفع مطور ثانوي - ثانوي .\n◉︙تنزيل الكل - تك .\n◉︙تعطيل الايدي بالصوره - تعط .\n◉︙تفعيل الايدي بالصوره - تفع .\n◉︙الرابط - ر .\n◉︙ردود المدير - رر .\n◉︙مسح المكتومين - ،، .\n◉︙اضف رد - رد .\n◉︙مسح سحكاتي - سح .\n◉︙مسح رسائلي - رس .\n◉︙غنيلي - غ .\n◉︙مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ WaTaN TeaM ›',url="t.me/IQTHON"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-----𝐒𝐎𝐔𝐑𝐂𝐑 𝐁𝐈𝐋𝐘-----
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '◉ WaTaN TeaM .',url="t.me/IQTHON"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
{{text="◉ السورس .",url="https://t.me/IQTHON"},{text="◉ لتنصيب بوت .",url="https://t.me/IQTHON/6109"}},{{text="◉ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
{{text = '◉ WaTaN TeaM .', url="t.me/IQTHON"}},
}
local msg_id = msg.id_/2097152/0.5
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ bily TeAM.',url="t.me/IQTHON"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
Text = "◉︙اهلا بك عزيزي \n◉︙عليك اضافة هذا البوت @kg7bot الى مجموعتك\n◉︙ثم رفعه مشرفا ثم اتبع الاوامر التاليه [هـنـا](https://t.me/IQTHON/6499)"
keyboard = {} 
keyboard.inline_keyboard = {
...
Text = "[⦑ Welcome to Source ⦒](t.me/IQTHON)\n[◉ ⦑ SOURCE WaTaN ⦒](t.me/IQTHON)\n◉ Source version : 3.2"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/IQTHON"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/watanupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/IQTHON/7"},
{text = '𝒘𝒂𝒕𝒂𝒏 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/joinchat/MJjy8Vab_jVmODdi"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/X_6_Z"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IQTHON&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-----𝐒𝐎𝐔𝐑𝐂𝐑 𝐁𝐈𝐋𝐘-----
...
local Text ='*◉︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/gif:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◉︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/memz:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◉︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/Song:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/remix:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◉︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/photo:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*◉︙تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/anime:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ◉",callback_data="/series:"..msg.sender_user_id_}},{{text = '◉ bily Team .',url="t.me/IQTHON"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/IQTHON' end
...
Text = "◉︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/IQTHON"}}}
...
Text = "◉︙تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/IQTHON"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevAbs:srem(bily.."Abs:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
Text = [[
◉︙[قناة السورس](https://t.me/IQTHON)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ قناة السورس',url="t.me/IQTHON"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IQTHON&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
