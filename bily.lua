...
--   This Is The Source Channel @XBBBBS .   --
--                - bily -                 --
--        -- https://t.me/XBBBBS --         --
------------------------------------------------ 
...
local UserName = (dp.username_ or "XBBBBS")
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'XBBBBS')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'XBBBBS')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "XBBBBS")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@XBBBBS]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@XBBBBS]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source bily     --
--        Contact         --
...
Text = [[
Welcome To Source
⌁︙[bily TeaM](https://t.me/H_L_5)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌁ Source Channel',url="https://t.me/H_L_5"}},{{text = '⌁ DeveLoper',url="t.me/X_6_Z"},{text = '⌁ Tws bily',url="https://t.me/LH1BOT"}},{{text= '⌁ Exp Source .',url="https://t.me/XJJJJS"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/H_L_5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source bily     --
if ChatType == 'sp' or ChatType == 'gp'  then
...
{{text = '⌁ bily TeAM .',url="t.me/XBBBBS"}},
}
local msg_id = msg.id_/2097152/0.5
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/XBBBBS' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "XBBBBS")..")"
else 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@XBBBBS]', 1, 'md')    
end 
--     Source bily     --
