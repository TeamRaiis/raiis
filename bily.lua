...
if text == (Redis:get(bily.."bily:Name:Bot") or "بيكوس") then
local NamesBot = (Redis:get(bily.."bily:Name:Bot") or "بيكوس")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌯ ︙أهلآ بك في بوت '..(Redis:get(bily.."bily:Name:Bot") or "بيكوس")..
