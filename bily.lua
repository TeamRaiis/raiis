...
--   This Is The 𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙱𝙸𝙻𝚈 @BILY_DEV .   --
--                - bily -                 --
--        -- https://t.me/BILY_DEV --         --
------------------------------------------------ 
...
⌯︙م6 ↫ اوامر الاعضاء
※┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉※
⌯︙[𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙱𝙸𝙻𝚈](https://t.me/BILY_DEV)
]] 
keyboard = {} 
...
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بيلي')
local bilyDeV = {"لتكول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, bilyDeV[math.random(#bilyDeV)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بيلي') 
local bilyDeV = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, bilyDeV[math.random(#bilyDeV)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(bily..'Abs:NameBot') or 'بيلي') then 
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بيلي')
local bilyDeV = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, bilyDeV[math.random(#bilyDeV)] , 1, 'html') 
return false 
end
...
Text = "[⌯⦑ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙸𝙻𝚈 ⦒](t.me/BILY_DEV)\n[⌯ ⦑ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙸𝙻𝚈 ⦒](t.me/BILY_DEV)\n[⌯ ⦑ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁𝙴 𝙾𝙵 𝚂𝙾𝚄𝚁𝙲𝙴⦒](t.me/X_6_Z)\n"
keyboard = {} 
...
if text == "راسلني" then
bilyDeV = {"ها هلاو","انطق","كول حبي","تفضل"};
...
local cont = (tonumber(DevAbs:get(bily..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local msguser = tonumber(DevAbs:get(bily..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local Texting = {"فديت صورتك حبي ،🤤💞","مقتنع بصورتك !؟ 😹🖤","ملاك وناسيك بكروبنه ،🤤💞","وفالله ،🤤💞","كشخه برب ،😉🤍","حبيبي دغير صورتك ليش مجلب ،💔🥺😕","صورتك موراحه ،🙄😶","حلغوم والله ،🥺💘","مو صوره غنبله براسها ٦٠ حظ ،😹🤍"}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝑠𝑜𝑢𝑟𝑐𝑒 𝑏𝑖𝑙𝑦 .',url="t.me/BILY_DEV"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '⌯ 𝑠𝑜𝑢𝑟𝑐𝑒 𝑏𝑖𝑙𝑦 .',url="t.me/BILY_DEV"}}} 
local msg_id = msg.id_/2097152/0.5 
...
Text = [[
⌯︙[𝙲𝙷𝙰𝙽𝙽𝙴𝙻 𝙾𝙵 𝚂𝙾𝚄𝚁𝙲𝙴](https://t.me/BILY_DEV)
⌯︙[𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁𝙴 𝙾𝙵 𝚂𝙾𝚄𝚁𝙲𝙴](https://t.me/X_6_Z)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
Text = [[
⌯︙[𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁𝙴 𝙾𝙵 𝚂𝙾𝚄𝚁𝙲𝙴](https://t.me/U_L_C)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯︙𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁𝙴 𝙾𝙵 𝚂𝙾𝚄𝚁𝙲𝙴',url="t.me/U_L_C"}},
}
local msg_id = msg.id_/2097152/0.5
