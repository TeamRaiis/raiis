...
os.execute('rm -rf bily.lua') 
os.execute('wget https://raw.githubusercontent.com/WaTaNTeaM/bily/main/bily.lua') 
dofile('bily.lua') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '◉ 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐ℎ𝑎𝑛𝑛𝑒𝑙',url="https://t.me/BILY_DEV"}},{{text = '◉ 𝑑𝑒𝑣𝑒𝑙𝑜𝑝𝑒𝑟',url="t.me/X_6_Z"},{text = '◉ 𝒕𝒘𝒔 𝒃𝒊𝒍𝒚',url="https://t.me/LH1BOT"}},{{text= '◉ 𝑒𝑥𝑝 𝑏𝑖𝑙𝑦 .',url="https://t.me/XJJJJS"}}}
local msg_id = msg.id_/2097152/0.5
