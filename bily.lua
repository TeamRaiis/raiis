...
local bilyDeV = '⌯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌯︙تم تفعيل الريمكس'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DevAbs, 14, string.len(msg.sender_user_id_))
...
local DevAbs = '⌯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌯︙تم تعطيل الريمكس'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DevAbs, 14, string.len(msg.sender_user_id_))
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/remix:"..msg.sender_user_id_}},{{text = '⌯ 𝑠𝑜𝑢𝑟𝑐𝑒 𝑏𝑖𝑙𝑦 .',url="t.me/BILY_DEV"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RIIMX/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source bily     --
if Admin(msg) then
