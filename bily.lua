...
if data.ChatMember.bily ~= true then
Var = false
keyboard = {} 
keyboard.inline_keyboard = {{{text=data.ChatMember.Title,url=data.ChatMember.Url}}} 
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(data.ChatMember.bily).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
Var = true
end
return Var
...
if text == 'تحويل' and not DevAbs:get(bily..'Abs:Thwel:Abs'..msg.chat_id_) and SourceCh(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(bily..'Abs:Antk:Abs'..msg.chat_id_) and SourceCh(msg) then
...
if text == "غنيلي" and not DevAbs:get(bily..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
