...
--   This Is The 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 @BILY_DEV .   --
--                - bily -                 --
--        -- https://t.me/BILY_DEV --         --
------------------------------------------------ 
...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(2063143862) then WaTaNTeaM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(bily) then WaTaNTeaM = 'البوت' elseif SudoId(user_id) then WaTaNTeaM = 'المطور الاساسي' elseif DevAbs:sismember(bily..'Abs:AbsSudo:', user_id) then WaTaNTeaM = 'المطور الاساسي' elseif DevAbs:sismember(bily..'Abs:SecondSudo:', user_id) then WaTaNTeaM = 'المطور الاساسي²' elseif DevAbs:sismember(bily..'Abs:SudoBot:', user_id) then WaTaNTeaM = DevAbs:get(bily.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(bily..'Abs:Owner:'..chat_id, user_id) then WaTaNTeaM = DevAbs:get(bily.."Abs:Owner:Rd"..chat_id) or 'المالك' elseif DevAbs:sismember(bily..'Abs:AbsConstructor:'..chat_id, user_id) then WaTaNTeaM = 'المالك' elseif DevAbs:sismember(bily..'Abs:BasicConstructor:'..chat_id, user_id) then WaTaNTeaM = DevAbs:get(bily.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(bily..'Abs:Constructor:'..chat_id, user_id) then WaTaNTeaM = DevAbs:get(bily.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(bily..'Abs:Managers:'..chat_id, user_id) then WaTaNTeaM = DevAbs:get(bily.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(bily..'Abs:Admins:'..chat_id, user_id) then WaTaNTeaM = DevAbs:get(bily.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(bily..'Abs:VipMem:'..chat_id, user_id) then  WaTaNTeaM = DevAbs:get(bily.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(bily..'Abs:Cleaner:'..chat_id, user_id) then  WaTaNTeaM = DevAbs:get(bily.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else WaTaNTeaM = DevAbs:get(bily.."Abs:mem:Rd"..chat_id) or 'العضو' end return WaTaNTeaM end
-----𝐒𝐎𝐔𝐑𝐂𝐑 𝐁𝐈𝐋𝐘-----
...
༺━┉ ┉━━※━━┉ ┉━༻
◉︙[𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](https://t.me/BILY_DEV)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevAbs:get(bily..'Abs:NameBot') or "بيلي")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(bily..'Abs:NameBot') or "بيلي")..' ','')
end
...
if text == '↫ السورس ◉' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه بتحديث  سورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ◉','↫ تحديث ◉'},
{'↫ السيرفر ◉'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه ب أحصائيات  سورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ◉'},
{'↫ المشتركين ◉','↫ المجموعات ◉'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه ب المطورين لسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه بالاذاعه لسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ◉'},
{'↫ اذاعه خاص ◉','↫ اذاعه عام ◉'},
...
if text == '↫ العام ◉' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه بالعام لسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي المطور \n◉︙اليك الازرار الخاصه بردود الخاص لسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي \n◉︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي \n◉︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ◉','↫ اغنيه ◉'},
{'↫ ميمز ◉','↫ ريمكس ◉'},
{'↫ صوره ◉','↫ متحركه ◉'},
...
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي \n◉︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس بيلي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ◉' then 
local Sudo_Welcome = '◉︙اهلا بك مجددا عزيزي \n◉︙اليك الازرار الخاصه بألعاب سورس بيلي فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
local inline = {
{{text="◉ المطور .",url="t.me/"..(dp.username_ or "BILY_DEV")}},
...
local WaTaNTeaM =  DevAbs:smembers(bily..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..WaTaNTeaM[math.random(#WaTaNTeaM)]..']' , 1, 'md')  
end
end
-----𝐒𝐎𝐔𝐑𝐂𝐑 𝐁𝐈𝐋𝐘-----
...
local WaTaNTeaM =  DevAbs:smembers(bily..'Abs:Text:KtTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..WaTaNTeaM[math.random(#WaTaNTeaM)]..']' , 1, 'md')  
end
end
-----𝐒𝐎𝐔𝐑𝐂𝐑 𝐁𝐈𝐋𝐘-----
...
if DevAbs:get('WaTaNTeaM:'..bily.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('WaTaNTeaM:'..bily..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '◉︙تم الغاء الامر', 1, 'md')
DevAbs:del('WaTaNTeaM:'..bily.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('WaTaNTeaM:'..bily.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('WaTaNTeaM:'..bily..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('WaTaNTeaM:'..bily.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('WaTaNTeaM:'..bily..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '◉︙تم الغاء الامر', 1, 'md')
DevAbs:del('WaTaNTeaM:'..bily.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('WaTaNTeaM:'..bily.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('WaTaNTeaM:'..bily..'ids:user'..msg.chat_id_)  
...
local BotName = (DevAbs:get(bily.."Abs:NameBot") or 'بيلي')
...
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بيلي')
local WaTaNTeaM = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بيلي') 
local WaTaNTeaM = {"اسمي القميل "..NameBot.." "} 
DevAbs2 = math.random(#WaTaNTeaM) 
Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM[DevAbs2] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(bily..'Abs:NameBot') or 'بيلي') then 
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بيلي')
...
Text = "[⦑ Welcome to Source ⦒](t.me/BILY_DEV)\n[✯ ⦑ SOURCE Billy ⦒](t.me/BILY_DEV)\n✯ Source version : 3.2"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙲𝙷𝙰𝙽𝙽𝙴𝙻 𝚂𝙾𝚞𝚁𝙲𝙴',url="t.me/BILY_DEV"},
{text = '𝚞𝙿𝙳𝙰𝚃𝙴 𝚂𝙾𝚞𝚁𝙲𝙴',url="t.me/@XJJJJS"}},
{{text = '𝙸𝙽𝚂𝚃𝙰𝙻𝙻 𝚂𝙾𝚞𝚁𝙲𝙴',url="https://t.me/BILY_DEV/7"},
{text = '𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙲𝙷𝙰𝙽𝙽𝙴𝙻',url="https://t.me/FIIS1"}},
{{text = '𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁',url="t.me/X_6_Z"}},
}
local msg_id = msg.id_/2097152/0.5
...
local WaTaNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,WaTaNTeaM, 1, 'md') 
local WaTaNTeaM = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..WaTaNTeaM[math.random(#WaTaNTeaM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
DevAbs:set('WaTaNTeaM:'..bily..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('WaTaNTeaM:'..bily.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('WaTaNTeaM:'..bily..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('WaTaNTeaM:'..bily.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set("bily:New:id:"..bily..msg.sender_user_id_,'WaTaNTeaM')
return "WaTaNTeaM"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '◉︙رجائا اتبع التعليمات للتعيين \n◉︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n༺━┉ ┉━━※━━┉ ┉━༻\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n༺━┉ ┉━━※━━┉ ┉━༻', 1, 'md')
DevAbs:set("bily:New:id:"..bily..msg.chat_id_..msg.sender_user_id_,'WaTaNTeaM')
return "WaTaNTeaM"
end
...
if text == "الروابط" then if DevAbs:get(bily..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الروابط ↫ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(bily..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙المعرف ↫ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(bily..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙المتحركه ↫ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(bily..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الملصقات ↫ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الصور" then if DevAbs:get(bily..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الصور ↫ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(bily..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الفيديو ↫ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(bily..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙الاونلاين ↫ "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(bily..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(bily..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙التوجيه ↫ "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(bily..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الاغاني ↫ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(bily..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙الصوت ↫ "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(bily..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(bily..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(bily..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "التعديل" then if DevAbs:get(bily..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙التعديل ↫ "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(bily..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙التثبيت ↫ "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(bily..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(bily..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الكلايش ↫ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الدخول" then if DevAbs:get(bily..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local WaTaNTeaM = "\n" .."◉︙الدخول ↫ "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(bily..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الشبكات ↫ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "المواقع" then if DevAbs:get(bily..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙المواقع ↫ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "العربيه" then if DevAbs:get(bily..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙العربيه ↫ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(bily..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local WaTaNTeaM = "\n" .."◉︙الانكليزيه ↫ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الكفر" then if DevAbs:get(bily..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local WaTaNTeaM = "\n" .."◉︙الكفر ↫ "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الفشار" then if DevAbs:get(bily..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local WaTaNTeaM = "\n" .."◉︙الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(bily..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local WaTaNTeaM = "\n" .."◉︙الطائفيه ↫ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, WaTaNTeaM, 1, 'md') end
end
-----𝐒𝐎𝐔𝐑𝐂𝐑 𝐁𝐈𝐋𝐘-----
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help0'..msg.sender_user_id_)
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help01'..msg.sender_user_id_)
if WaTaNTeaM == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help21'..msg.sender_user_id_)
if WaTaNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help31'..msg.sender_user_id_)
if WaTaNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help41'..msg.sender_user_id_)
if WaTaNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help51'..msg.sender_user_id_)
if WaTaNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local WaTaNTeaM =  DevAbs:get(bily..'Abs:Help61'..msg.sender_user_id_)
if WaTaNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
DevAbs:set(bily..'Abs:NameBot',(DevAbs:get(bily..'Name:Bot') or 'بيلي'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
