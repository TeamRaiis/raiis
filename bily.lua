...
keyboard = {}
keyboard.inline_keyboard = {{{text=''..result.first_name_..'',url="https://t.me/"..result.username_..""}},{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/BILY_DEV"}},{{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/XJJJJS"}},{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/FIIS1"}}} 
local msg_id = msg.id_/2097152/0.5
