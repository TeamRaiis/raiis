...
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بورني')
--     Source bily     --
...
if text and text:match('^'..(DevAbs:get(bily..'Abs:NameBot') or "بورني")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(bily..'Abs:NameBot') or "بورني")..' ','')
end
...
local BotName = (DevAbs:get(bily.."Abs:NameBot") or 'بورني')
...
if text and text == (DevAbs:get(bily..'Abs:NameBot') or 'بورني') then 
NameBot = (DevAbs:get(bily..'Abs:NameBot') or 'بورني')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝑡𝑖𝑔𝑒𝑟 𝑡𝑒𝑎𝑚 .',url="t.me/BILY_DEV"}},
}
local msg_id = msg.id_/2097152/0.5
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './bily.lua', '⌯︙نسخة ملف سورس بورني',dl_cb, nil)
end end
--     Source bily     --
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/bilyDeV/bilyFiles/bily/getfile.json")
if res == 200 then
