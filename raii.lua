...
msg.Name_Controller = 'مبرمـج السورس '
msg.The_Controller = 1
...
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمـج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ ︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمـج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ ︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
...
if text == 'تعطيل بلاي' and Owner(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id..'lockGeamVip'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'*⋄︙تم تعطيل بلاي*')
end
if text == 'تفعيل بلاي' and Owner(msg) and msg.reply_to_message_id_ == 0 then 
...
{{text = '- 𝒓𝒂𝒍𝒍𝒔 ᵀᴱᴬᴹ .', url="t.me/RallsTeam1"}},
{{text = 'مبرمـج السورس', url="t.me/QQ070"}},
}
...
{
{text = 'Annotations Source', url = 'https://t.me/XJJJJS'}, 
},
{
{text = 'programmer Source', url = 't.me/QQ070'}, 
},
{
{text = 'Developer Channel !', url = 't.me/H_L_5'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
local NamesBot = (Redis:get(raiis.."raiis:Name:Bot") or "ميلا")
local BotName = {
"شوف ابو راس احترم نفسك 😂♥"..NamesBot,
